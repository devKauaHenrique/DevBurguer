...
function addToCart(name,price){
    ...
    if(existingItem){
        //Se o item já existe, apenas aumenta a quantidade + 1
...
function updateCartModal(){
    ...
    //Formatar o texto em valor de moeda do Brasil
...
checkoutBtn.addEventListener('click', function(){
    ...
    if(!isOpen){
        ...
        Toastify({
            text: "Ops, a nossa hamburgueria está fechada!",
            duration: 3000,
            close: true,
...
function checkRestaurantOpen(){
    ...
    return hora >= 18 && hora < 1; //true = Restaurante está aberto
}
